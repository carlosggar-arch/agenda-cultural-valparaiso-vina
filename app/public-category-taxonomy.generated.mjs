...
export const PUBLIC_CATEGORY_TAXONOMY = Object.freeze({
  ...
  "rules": {
    "description_evidence": [
      ...
      {
        "category": "musica",
        "pattern": "\\b(?:musica|conciertos?|recital(?:es)?|coros?|orquestas?|cantautor(?:es)?|cantautoras?|djs?|tributo|banda tributo|homenaje musical|album(?:es)?|discos?|giras?|tour|bandas?|cancion(?:es)?|cantantes?|vocalistas?|guitarras?|pianos?|violines?|saxofones?|baterias?|tocata|tocatas|ensemble|gospel|choir|filarmonica|clasica|cuarteto|quartet|duo|trio|oratorio|cantata|sinfonia|sonata|acordeon|organetto|boleros?|vals(?:es)?|vinilos?|gipsy kings?|samba|batucada)\\b",
        "weight": 35
      },
      {
        "category": "musica",
      ...
      {
        "category": "teatro",
        "pattern": "\\b(?:obra de teatro|pieza teatral|teatral(?:es)?|danza|ballet|circo|escenic[oa]s?|performance|funcion teatral|comedia musical|teatro musical|obra musical|espectaculo musical|monologo|stand up|humor|comedia|show de magia|espectaculo de magia|ilusionismo|mago|maga|ilusionista)\\b",
        "weight": 40
      },
      {
      ...
      {
        "category": "literatura",
        "pattern": "\\b(?:libros?|novelas?|poemarios?|cuentos? original(?:es)?|literatura|literari[oa]s?|lectura|poesia|recital poetico|encuentro literario)\\b",
        "weight": 35
      },
      {
        "category": "naturaleza-aire-libre",
        "pattern": "\\b(?:senderismo|trekking|excursion|caminata|aire libre|observacion de aves|avistamiento)\\b",
        "weight": 35
      },
      {
      ...
      {
        "category": "literatura",
        "pattern": "\\b(?:cuentacuentos?|narracion oral|narraciones orales|(?:escuchar|contar|narrar) (?:cuentos|historias|relatos))\\b",
        "weight": 120
      }
    ],
    ...
    "title_evidence": [
      ...
      {
        "category": "musica",
        "pattern": "\\b(?:tributo|rock|pop|soul|funk|indie|crossover|cantautor|cantautora|album(?:es)?|discos?|giras?|tour|bandas?|cancion(?:es)?|cantantes?|vocalistas?|guitarras?|pianos?|violines?|saxofones?|baterias?)\\b",
        "weight": 105
      },
      {
        "category": "teatro",
      ...
      {
        "category": "teatro",
        "pattern": "\\b(?:teatral(?:es)?|obra teatral|obra de teatro|teatro|danza|ballet|circo|performance|funcion teatral|espectaculo escenico)\\b",
        "weight": 140
      },
      {
        "category": "teatro",
      ...
      {
        "category": "naturaleza-aire-libre",
        "pattern": "\\b(?:senderismo|trekking|excursion|caminata|ruta guiada|salida a terreno|observacion de aves|avistamiento|aire libre)\\b",
        "weight": 140
      },
      {
        "category": "ferias-vida-local",
      ...
      {
        "category": "literatura",
        "pattern": "\\b(?:cuentacuentos?|narracion oral|narraciones orales)\\b",
        "weight": 140
      }
    ]
  },
