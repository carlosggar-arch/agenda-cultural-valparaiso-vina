...
export const PUBLIC_CATEGORY_TAXONOMY = Object.freeze({
  ...
  "rules": {
    "description_evidence": [
      ...
      {"category": "musica", "pattern": "\\b(?:musica|concierto|recital|jazz|coro|orquesta|cantautor|cantautora|dj|tributo|banda tributo|homenaje musical|album|disco|gira|tour|banda|cantante|vocalista|guitarra|piano|violin|saxofon|bateria|blues|flamenco|reggae|beatbox)\\b", "weight": 30},
    ...
    "title_evidence": [
      ...
      {"category": "musica", "pattern": "\\b(?:concierto|recital|jazz|coro|coral|orquesta|tocata|festival de musica|blues|flamenco|reggae|beatbox)\\b", "weight": 140},
      {"category": "musica", "pattern": "\\b(?:tributo|rock|pop|soul|funk|indie|cantautor|cantautora|album|disco|gira|tour|banda|cantante|vocalista|guitarra|piano|violin|saxofon|bateria)\\b", "weight": 105},
