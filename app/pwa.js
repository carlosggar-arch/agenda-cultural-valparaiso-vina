...
import "./favorites.js";
import "./mobile-experience.js?v=20260817-topnav4";
import "./share-qr.js";
...
async function registerAgendaServiceWorker() {
  ...
  try {
    const registration = await navigator.serviceWorker.register("./service-worker.js?v=43", { scope: "./", updateViaCache: "none" });
