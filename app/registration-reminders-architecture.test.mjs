...
const shellManifest = await readFile(new URL("./service-worker-assets.generated.js", import.meta.url), "utf8");
...
assert.match(serviceWorker, /service-worker-assets\.generated\.js/, "offline shell must use the generated manifest");
assert.match(shellManifest, /"\.\/registration-reminders\.js"/, "the common reminder component must work offline too");
