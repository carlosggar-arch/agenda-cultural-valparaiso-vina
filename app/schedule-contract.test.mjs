...
const first=normalizeScheduleContractDataset({events:[mixed,two,doors,interval,ambiguous,occ,exhibition]}); assert.deepEqual(normalizeScheduleContractDataset(first),first);
