...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply Visita Viña coverage for Museo Fonck without erasing existing recovery or verified-inactivity overrides.")
