...
export function dateSpecificHours(display, dateKey) {
  ...
  // If the official schedule contains applicable, weekday-bounded opening
  // clauses and none includes the selected date, the venue is closed that day.
  // This is different from an unparseable schedule, for which we keep null.
